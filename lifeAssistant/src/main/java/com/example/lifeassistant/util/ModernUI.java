...
//Metro UI 2012��8�£���Ϊ��¹�������Metro AG���̱�Ȩ��ͻ��΢���������Metro UI���ᷨ�����֮��Modern UI���ƺ�Windows 8ȫ�µĿ�ʼ������
public class ModernUI extends ImageView {
	...
	public ModernUI(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		camera = new Camera();
	}
	public ModernUI(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}

	public ModernUI(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		camera = new Camera();
	}
